...
class MPassbookAdapter (private val items: ArrayList<TransactionData>):
    RecyclerView.Adapter<MPassbookAdapter.PassbookViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MPassbookAdapter.PassbookViewHolder, position: Int) {
